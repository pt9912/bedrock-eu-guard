...
([`LH-RM-004`](../../spec/lastenheft.md)/[`LH-RM-005`](../../spec/lastenheft.md)). **Letzte Änderung:** 2026-06-24.
...
- **Einzelnes Binary** als primäres Artefakt ([`LH-TECH-001`](../../spec/lastenheft.md),
  Sprachwahl [ADR-0002](../plan/adr/0002-implementierungssprache.md)).
- **Docker-Image** ([`LH-TECH-004`](../../spec/lastenheft.md)):
  `docker run --rm -v "$PWD:/work" bedrock-eu-check all`.
- **Devcontainer-Feature / vorinstalliertes Tool** ([`LH-TECH-005`](../../spec/lastenheft.md)).
- **Reproduzierbarer Build** über `make` ([`LH-QA-004`](../../spec/lastenheft.md)); Toolchain
...
| Exit | Bedeutung |
|---|---|
| `0` | kein `FAIL`-Finding ([`LH-FA-EXIT-001`](../../spec/lastenheft.md)) |
| `1` | mindestens ein `FAIL` ([`LH-FA-EXIT-002`](../../spec/lastenheft.md)) |
| `2` | Tool-Fehler ([`LH-FA-EXIT-003`](../../spec/lastenheft.md)) |

CI bricht bei `1` ab ([`LH-ZIEL-004`](../../spec/lastenheft.md), [`LH-PRI-MUSS-005`](../../spec/lastenheft.md)).
...
- Das Tool benötigt für AWS-Checks nur **lesende** IAM-Rechte
  ([`LH-SEC-003`](../../spec/lastenheft.md)/[`LH-SEC-004`](../../spec/lastenheft.md)); minimale Policy wird mit Welle 3 dokumentiert.
- Es gibt **keine** Secrets aus ([`LH-NF-004`](../../spec/lastenheft.md)) und speichert keine
  Credentials ([`LH-SEC-001`](../../spec/lastenheft.md)/[`LH-SEC-002`](../../spec/lastenheft.md)).
